# MS-COCO detection / instance segmentation (Mask R-CNN, 25 epochs, global batch 16)
...
CONFIG_FILE=./configs/detection/coco_maskrcnn_vitb16.yaml  # REPLACE with your config file path
...
torchrun \
    ...
    --master_addr=$ADDR \
    --master_port=$PORT \
    main.py --config_file $CONFIG_FILE --task detection
