# Clevr/Count low-level reasoning (VTAB-1k). Switch CONFIG_FILE to clevr_dist.yaml for Clevr/Dist
...
CONFIG_FILE=./configs/lowlevel/clevr_count.yaml  # REPLACE with your config file path
